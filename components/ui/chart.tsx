...
export function ChartTooltip({ className, formatter, labelFormatter, ...props }: ChartTooltipProps) {
  return (
    <Tooltip
          ...
          <div className={cn("rounded-lg border bg-background p-2 shadow-sm", className)}>
            ...
            <div className="flex flex-col gap-0.5">
              {payload.map((item: any, i: number) => {
                ...
                const formattedName = formatter ? formatter(item.value, item.name)[1] : item.name
